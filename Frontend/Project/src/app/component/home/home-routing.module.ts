...
const routes: Routes = [
  ...
  children: [
    ...
    { path: 'edit-teacher/:tec_ID', component: EditTeacherComponent, canActivate: [IsAuthenticatedGuard, HasRoleGuard], data:{role: ["Employee"]} },
    ...
    { path: 'course', component: CourseComponent, canActivate: [IsAuthenticatedGuard, HasRoleGuard], data:{role: ["Employee", "Student"]} },
